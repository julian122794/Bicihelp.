...
<body>
    <div class="container">
        ...
        <div class="edit-profile">
            <h2>Editar perfil contratista </h2>
            <form action="#">
                ...
                <div class="form-group">
                    <label for="full-name">Tipo de estudio</label>
                    <input type="text" id="full-name" placeholder="Jorge">
                </div>
                <div class="form-group">
                    <label for="full-name">tipo de documento</label>
                    <input type="text" id="full-name" placeholder="Jorge">
                </div>
                <div class="form-group">
                    <label for="full-name">Numero de documento </label>
                    <input type="text" id="full-name" placeholder="Jorge">
                </div>
                ...
                <h3>Complementos</h3>
                <div class="form-group">
                    <label for="facebook">ciudad </label>
                    <input type="text" id="facebook" placeholder="Facebook Username">
                </div>
                <div class="form-group">
                    <label for="twitter">especialidad.</label>
